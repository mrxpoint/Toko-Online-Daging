        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-md-6">
            ...
            <p class="store-subtitle-landing" style="line-height: 28px; color: rgb(146, 146, 146);">
              The Chicken Meat adalah toko daging yang menjual daging Ayam segar,
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-12">
          <p class="pt-4 pb-2">
            &copy; 2023 Copyright by The Chicken Meat. All Rights Reserved. |  <a href='https://www.bacacot.wiki' title='StokCoding.com' target='_blank'>TheChickenMeat.com</a>
          </p>
        </div>
      </div>
    </div>
